  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        <Text style={styles.certificateTitle}>Certified Atlet Nasionalr</Text>
        <Text style={styles.issuer}>Atlet Renang</Text>
        <Text style={styles.date}>Diterbitkan: Maret 2021</Text>
        <Text style={styles.description}>
          Bahwasanya yang bersangkutan telah menyelesaikan lomba renang dengan predikat memuaskan.
        </Text>
      </View>
